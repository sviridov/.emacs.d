...
(define-key sp-keymap (kbd "M-C") 'sp-convolute-sexp)
(define-key sp-keymap (kbd "M-A") 'sp-absorb-sexp)
(define-key sp-keymap (kbd "M-E") 'sp-emit-sexp)
(define-key sp-keymap (kbd "C-S-<left>") 'sp-add-to-previous-sexp)
